...
void stop_pwm_output(void)
{
  ...
  HAL_GPIO_WritePin(BLDC_OCNPWM1_GPIO_PORT, BLDC_OCNPWM1_PIN, GPIO_PIN_RESET);    // 关闭下桥臂
  HAL_GPIO_WritePin(BLDC_OCNPWM2_GPIO_PORT, BLDC_OCNPWM2_PIN, GPIO_PIN_RESET);    // 关闭下桥臂
  HAL_GPIO_WritePin(BLDC_OCNPWM3_GPIO_PORT, BLDC_OCNPWM3_PIN, GPIO_PIN_RESET);    // 关闭下桥臂
}
	...
	if(get_BLDC_direction() == MOTOR_FWD)
		{
			switch(step)
			{
				case 1:    /* U+ W- */
					...
					HAL_GPIO_WritePin(BLDC_OCNPWM3_GPIO_PORT, BLDC_OCNPWM3_PIN, GPIO_PIN_SET);      // 开启下桥臂
					break;
				...
				case 2:     /* V+ U- */
					...
					HAL_GPIO_WritePin(BLDC_OCNPWM1_GPIO_PORT, BLDC_OCNPWM1_PIN, GPIO_PIN_SET);      // 开启下桥臂
				...
				case 4:     /* W+ V- */
					...
					HAL_GPIO_WritePin(BLDC_OCNPWM2_GPIO_PORT, BLDC_OCNPWM2_PIN, GPIO_PIN_SET);      // 开启下桥臂 
					break;
